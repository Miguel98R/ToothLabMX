...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="col-12 col-sm-12 col-md-6 col-lg-6 py-2" style="margin:0px;padding:0px;">
...
<table class="table text-left table-bordered table-hover table-sm ">
  ...
  <h5 class="text-center py-2 font-weight-bolder text-white"><i class="fas fa-plus"></i>&nbsp; Crear orden</h5>
    ...
    <tr>
    <th ><p>  <label class="font-weight-bolder">Dr:</label>  <input style="width:70%" list="dentista"  name="dentista" class="inputDato " placeholder="Selecciona un dentista:" required>
                        <datalist class="inputDato" id="dentista">
                        <?php
                            while($datos=$result->fetch_assoc()){
                            ?>
                            <option  value="<?php echo strtoupper($datos['nombre']);?>"></option>
                            <?php }?>
                            </datalist>
                          </p>
                        </th>
...
<table class="table table-hover table-sm">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>  <input list="productos" style="font-size: 13px;"   name="producto" class="inputDato w-100" placeholder="Selecciona un producto:" >
      ...
      <td width="200"> <input list="colores" style="font-size: 13px;"   name="color" class="inputDato w-100" placeholder="Color:" >
...
<div class="container-fluid text-center">
       ...
       <div class="row ">
                        ...
                        <input type="checkbox" style="display: none;" id="18" tu-attr-precio="1" class="mis-checkboxes " name ="od[]" value="18">
                                  <label class="font-weight-bold" style="border: 2px solid rgb(188, 188, 245);padding: 2px;" onclick = "changeColor(this);"  for="18">18</label>
                                   <input type="checkbox" style="display: none;" id="17" tu-attr-precio="1" class="mis-checkboxes" name ="od[]" value="17">
                                  <label class="font-weight-bold" style="border: 2px solid rgb(188, 188, 245);padding: 2px;" onclick = "changeColor(this);"  for="17">17</label>
                                  <input type="checkbox" style="display: none;" id="16" tu-attr-precio="1" class="mis-checkboxes" name="od[]" value="16">
                                  <label class="font-weight-bold" style="border: 2px solid rgb(188, 188, 245);padding: 2px;" onclick = "changeColor(this);"for="16">16</label>
                                <input type="checkbox" style="display: none;" id="15" tu-attr-precio="1" class="mis-checkboxes" name="od[]" value="15">
                                  <label class="font-weight-bold" style="border: 2px solid rgb(188, 188, 245);padding: 2px;" onclick = "changeColor(this);"for="15">15</label>
                                <input type="checkbox" style="display: none;" id="14"  tu-attr-precio="1" class="mis-checkboxes" name="od[]" value="14">
                                  <label class="font-weight-bold" style="border: 2px solid rgb(188, 188, 245);padding: 2px;" onclick = "changeColor(this);"for="14">14</label>
                                <input type="checkbox" style="display: none;" id="13" tu-attr-precio="1"  class="mis-checkboxes" name="od[]" value="13">
                                  <label class="font-weight-bold" style="border: 2px solid rgb(188, 188, 245);padding: 2px;" onclick = "changeColor(this);"for="13">13</label>
                                <input type="checkbox" style="display: none;" id="12" tu-attr-precio="1" class="mis-checkboxes" name="od[]" value="12">
                                  <label class="font-weight-bold" style="border: 2px solid rgb(188, 188, 245);padding: 2px;" onclick = "changeColor(this);"for="12">12</label>
                                <input type="checkbox" style="display: none;" id="11" tu-attr-precio="1" class="mis-checkboxes" name="od[]" value="11">
                                  <label class="font-weight-bold" style="border: 2px solid rgb(188, 188, 245);padding: 2px;" onclick = "changeColor(this);"for="11">11</label>
                        ...
                        <div style="color:firebrick; " class=" text-left col  py-2 ">
                                ...
                                <input type="checkbox" style="display: none;" id="21" tu-attr-precio="1" class="mis-checkboxes" name="od[]" value="21">
                                  <label class="font-weight-bold" style="border: 2px solid rgb(188, 188, 245);padding: 2px;" onclick = "changeColor(this);"for="21">21</label> 
                                <input type="checkbox" style="display: none;" id="22" tu-attr-precio="1" class="mis-checkboxes" name="od[]" value="22">
                                  <label class="font-weight-bold" style="border: 2px solid rgb(188, 188, 245);padding: 2px;" onclick = "changeColor(this);"for="22">22</label>
                                <input type="checkbox" style="display: none;" id="23" tu-attr-precio="1"  class="mis-checkboxes" name="od[]" value="23">
                                  <label class="font-weight-bold" style="border: 2px solid rgb(188, 188, 245);padding: 2px;" onclick = "changeColor(this);"for="23">23</label>
                                <input type="checkbox" style="display: none;" id="24" tu-attr-precio="1"  class="mis-checkboxes" name="od[]" value="24">
                                  <label class="font-weight-bold" style="border: 2px solid rgb(188, 188, 245);padding: 2px;" onclick = "changeColor(this);"for="24">24</label>
                                <input type="checkbox" style="display: none;" id="25" tu-attr-precio="1" class="mis-checkboxes"  name="od[]" value="25">
                                  <label class="font-weight-bold" style="border: 2px solid rgb(188, 188, 245);padding: 2px;" onclick = "changeColor(this);"for="25">25</label>
                                <input type="checkbox" style="display: none;" id="26" tu-attr-precio="1"  class="mis-checkboxes" name="od[]" value="26">
                                  <label class="font-weight-bold" style="border: 2px solid rgb(188, 188, 245);padding: 2px;" onclick = "changeColor(this);"for="26">26</label>
                                <input type="checkbox" style="display: none;" id="27" tu-attr-precio="1" class="mis-checkboxes" name="od[]" value="27">
                                  <label class="font-weight-bold" style="border: 2px solid rgb(188, 188, 245);padding: 2px;" onclick = "changeColor(this);"for="27">27</label>
                                <input type="checkbox" style="display: none;" id="28" tu-attr-precio="1" class="mis-checkboxes" name="od[]" value="28">
                                  <label class="font-weight-bold" style="border: 2px solid rgb(188, 188, 245);padding: 2px;" onclick = "changeColor(this);"for="28">28</label>
                    ...
                    <div class="row ">
                        <div class="text-success col text-right py-2">
                            <input type="checkbox" style="display: none;" style="display: none;" id="48" tu-attr-precio="1" class="mis-checkboxes" name="od[]" value="48 ">
                                  <label class="font-weight-bold" style="border: 2px solid rgb(188, 188, 245);padding: 2px;" onclick = "changeColor(this);"for="48">48</label>
                                <input type="checkbox" style="display: none;" id="47" tu-attr-precio="1" class="mis-checkboxes" name="od[]" value="47">
                                  <label class="font-weight-bold" style="border: 2px solid rgb(188, 188, 245);padding: 2px;" onclick = "changeColor(this);"for="47">47</label>
                                <input type="checkbox" style="display: none;" id="46" tu-attr-precio="1" class="mis-checkboxes" name="od[]" value="46">
                                  <label class="font-weight-bold" style="border: 2px solid rgb(188, 188, 245);padding: 2px;" onclick = "changeColor(this);"for="46">46</label>
                                <input type="checkbox" style="display: none;" id="45" tu-attr-precio="1" class="mis-checkboxes" name="od[]" value="45">
                                  <label class="font-weight-bold" style="border: 2px solid rgb(188, 188, 245);padding: 2px;" onclick = "changeColor(this);"for="45">45</label>
                                <input type="checkbox" style="display: none;" id="44" tu-attr-precio="1" class="mis-checkboxes" name="od[]" value="44">
                                  <label class="font-weight-bold" style="border: 2px solid rgb(188, 188, 245);padding: 2px;" onclick = "changeColor(this);"for="44">44</label>
                                <input type="checkbox" style="display: none;" id="43" tu-attr-precio="1" class="mis-checkboxes" name="od[]" value="43">
                                  <label class="font-weight-bold" style="border: 2px solid rgb(188, 188, 245);padding: 2px;" onclick = "changeColor(this);"for="43">43</label>
                                <input type="checkbox" style="display: none;" id="42" tu-attr-precio="1" class="mis-checkboxes" name="od[]" value="42">
                                  <label class="font-weight-bold" style="border: 2px solid rgb(188, 188, 245);padding: 2px;" onclick = "changeColor(this);"for="42">42</label>
                                <input type="checkbox" style="display: none;" id="41" tu-attr-precio="1" class="mis-checkboxes" name="od[]" value="41">
                                  <label class="font-weight-bold" style="border: 2px solid rgb(188, 188, 245);padding: 2px;" onclick = "changeColor(this);"for="41">41</label>
                        ...
                        <div style="color:orange; " class=" text-left col py-2 ">
                                ...
                                <input type="checkbox" style="display: none;" id="31" tu-attr-precio="1" class="mis-checkboxes" name="od[]" value="31">
                                  <label class="font-weight-bold" style="border: 2px solid rgb(188, 188, 245);padding: 2px;" onclick = "changeColor(this);"for="31">31</label>
                                <input type="checkbox" style="display: none;" id="32" tu-attr-precio="1" class="mis-checkboxes" name="od[]" value="32">
                                  <label class="font-weight-bold" style="border: 2px solid rgb(188, 188, 245);padding: 2px;" onclick = "changeColor(this);"for="32">32</label>
                                <input type="checkbox" style="display: none;" id="33" tu-attr-precio="1" class="mis-checkboxes"  name="od[]" value="33">
                                  <label class="font-weight-bold" style="border: 2px solid rgb(188, 188, 245);padding: 2px;" onclick = "changeColor(this);"for="33">33</label>
                                <input type="checkbox" style="display: none;" id="34" tu-attr-precio="1" class="mis-checkboxes" name="od[]" value="34">
                                  <label class="font-weight-bold" style="border: 2px solid rgb(188, 188, 245);padding: 2px;" onclick = "changeColor(this);"for="34">34</label>
                                <input type="checkbox" style="display: none;" id="35" tu-attr-precio="1" class="mis-checkboxes" name="od[]" value="35">
                                  <label class="font-weight-bold" style="border: 2px solid rgb(188, 188, 245);padding: 2px;" onclick = "changeColor(this);"for="35">35</label>
                                <input type="checkbox" style="display: none;" id="36" tu-attr-precio="1" class="mis-checkboxes" name="od[]" value="36">
                                  <label class="font-weight-bold" style="border: 2px solid rgb(188, 188, 245);padding: 2px;" onclick = "changeColor(this);"for="36">36</label>
                                <input type="checkbox" style="display: none;" id="37" tu-attr-precio="1" class="mis-checkboxes" name="od[]" value="37">
                                  <label class="font-weight-bold" style="border: 2px solid rgb(188, 188, 245);padding: 2px;" onclick = "changeColor(this);"for="37">37</label>
                                <input type="checkbox" style="display: none;" id="38" tu-attr-precio="1" class="mis-checkboxes" name="od[]" value="38">
                                  <label class="font-weight-bold"  style="border: 2px solid rgb(188, 188, 245);padding: 2px;" onclick = "changeColor(this);"for="38">38</label>
                            </div>
                    </div>
</div>
  <hr>
  ...
  <div class="text-center py-2">
    ...
    <div class="text-center col-12 col-sm-12 col-md-6 col-lg-6 py-2" style="margin:0px;padding:1px;">
