            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    <input type="text" class="form-control inputDato" name="inputName" id="inputName"
                        placeholder="Ingresa el nombre del doctor (un nombre  y un apellido) " required>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    <input type="text" class="form-control inputDato" name="inputCelular" id="inputCelular"
                        placeholder="Ingrese un numero celular o telefono " maxlength="10" required>

                </div>
                <div class="form-group col-md-6">
                    <input type="text" class="form-control inputDato" name="inputCelularConsultorio"
                        id="inputCelularConsultorio" maxlength="10" placeholder="Ingresa un numero celular o telefono del consultorio" required>
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    <input type="text" class="form-control inputDato" name="inputDomicilio" id=" inputDomicilio"
                        placeholder="Ingrese la direccion del doctor " required>

                </div>
                <div class="form-group col-md-6">
                   <Label style="font-size: 16px;" class="m-2">
                       Escoje un color:
                   </Label>  <input type="color" name="color" id="color" required>
                </div>
            </div>
