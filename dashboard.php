...
if (!isset($user)) {
  ...
  ?>
    ...
    <body>
        ...
        <header>
            <div class="py-3 cabeza">
                <div>
                    <h1 class="font-weight-bold py-5 align-content-center" style="display: flex;justify-content: center;width: 100%;font-size:50px;color:white;">Crear orden
                    </h1>
                </div>
            </div>
            </div>
        ...
        <form action="util/guardarOrden.php" autocomplete="off" method="POST">
                    ...
                    <div class="row ">
                        <div class="col-md-6 px-4 ">
                            ...
                            <div class="row ">
                                ...
                                <div class="px-2 " style="color:darkkhaki; ">
                                    ...
                                    <input type="checkbox" id="AcrilicoTransparente " name="color[]" value="AcrilicoTransparente ">
                                    <label for="Acrilico Transparente ">Acrilico Transparente</label><br>
                                </div>
                                ...
                                <div class="px-2 py-2 col-sm-12 ">
                                    ...
                                    <option value="QueColoR?">¿Que color?</option>
                                </select>
                                </div>
                            </div>
                        </div>
            ...
            <div class=" text-center py-2 col-md-12 ">
                <button class="button3 my-5 " type="submit ">Crear</button>
            </div>
